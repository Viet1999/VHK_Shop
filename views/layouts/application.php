...
<head>
	<title> VHK_Shop - Thể hiện sự lịch lãm của phái mạnh! </title>
	<meta charset="utf-8">
	<base href="/VHK_Shop/">
...
<body>
	<header id='header'>
		...
		<div class="header-detail">
			<p>Số 12 - Đường Trịnh Đình Thảo - P. Hòa Thạnh - Q. Tân Phú - Tp. HCM - Việt Nam<br>
		...
		<div class="container-fluid">
			...
			<div class="navbar-header">
				<button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse">
					<span class="sr-only">Toggle navigation</span> <!-- thay đổi màu thanh biểu tượng-->
					<span class="icon-bar"></span>
					<span class="icon-bar"></span>
					<span class="icon-bar"></span>
				</button>
				<a class="navbar-brand logo" href="">VHK_Shop</a>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-8" style="text-align: center; padding: 20px 0;">
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.477576279842!2d106.63214551468722!3d10.774687292322733!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752ea168a65c0b%3A0x2a4a7dc43e177de1!2zMTIgVHLhu4tuaCDEkMOsbmggVGjhuqNvLCBIb8OgIFRoYW5oLCBUw6JuIFBow7osIFRow6BuaCBwaOG7kSBI4buTIENow60gTWluaCwgVmnhu4d0IE5hbQ!5e0!3m2!1svi!2s!4v1633957397778!5m2!1svi!2s" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
				</div>
				<div class="col-lg-4" id="contact">
					<h3>Contact</h3>
					<i class="glyphicon glyphicon-map-marker"></i><span> Dương Văn Dương - Tân Phú - TP.HCM </span><br>
					<i class="glyphicon glyphicon-earphone"></i><span> (098) 111 235</span><br>
					<i class="glyphicon glyphicon-envelope"></i><span> VHK_Shop@gmail.com</span><br>
				...
				<div class="col-lg-12" id="copyright-txt">
					<b>All right reverse, &#169; copyright of VHK_Shop.com</b>
				</div>
			</div>
		</div>
	</footer>
