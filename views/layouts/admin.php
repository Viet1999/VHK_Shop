...
<head>
  ...
  <title>VHK_Shop | AdminPage</title>
  <base href="/VHK_Shop/">
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="indexadmin/Dashboard" class="logo">
        ...
        <span class="logo-lg"><b>VHK</b>Shop.<b>Admin</b></span>
      </a>
        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="views/admin/AdminLTE/dist/img/beauty_20200131163647.jpg" class="user-image" alt="User Image">
                <span class="hidden-xs"><?php echo $_SESSION['admin']['ten'] ?></span>
              </a>
              <ul class="dropdown-menu">
                <!-- User image -->
                <li class="user-header">
                  <img src="views/admin/AdminLTE/dist/img/beauty_20200131163647.jpg" class="img-circle" alt="User Image">
    ...
    <footer class="main-footer">
      ...
      <strong>Copyright &copy; 2021 by AdminLTE <a href="https://adminlte.io">Almsaeed Studio</a>.</strong> All rights
      reserved.
    </footer>
  </div>
  <!-- ./wrapper -->
    ...
    function logout() {
      $.ajax({
        ...
        success: function(result) {
          location.replace('http://localhost:8080/VHK_Shop/indexadmin');
        }
      });
    }
  </script>
